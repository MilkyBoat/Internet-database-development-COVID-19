...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../../backend/web/css/animate.css">
    <link rel="stylesheet" href="../../../backend/web/css/owl.carousel.min.css">

    <link rel="stylesheet" href="../../../backend/web/css/magnific-popup.css">
    <link rel="stylesheet" href="../../../backend/web/css/aos.css">

    <link rel="stylesheet" href="../../../backend/web/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="../../../backend/web/css/jquery.timepicker.css">

    <link rel="stylesheet" href="../../../backend/web/fonts/ionicons/css/ionicons.min.css">
    <link rel="stylesheet" href="../../../backend/web/fonts/fontawesome/css/font-awesome.min.css">

    <link rel="stylesheet" href="../../../backend/web/fonts/flaticon/font/flaticon.css">
  ...
  <body class="bg-light">
    ...
    <div class="site-wrap">
      ...
      <nav class="site-menu" id="ftco-navbar-spy">
        <div class="site-menu-inner" id="ftco-navbar">
          <ul class="list-unstyled">
            ...
            <li><a href="../../../backend/web/video">Videos</a></li>
            <li><a href="../../../backend/web/article">Blogs</a></li>
            <li><a href="../../../backend/web/comment">Comments</a></li>
            <li><a href="../../../backend/web/contactform">Contact Info</a></li>
          </ul>
        </div>
      </nav>
      ...
      <header class="site-header">
        <div class="row align-items-center">
          ...
          <div class="col-2 col-md-6 text-center site-logo-wrap">
            <a href="index" class="site-logo">M</a>
          </div>
      ...
      <div class="main-wrap " id="section-home">
        ...
        <div class="section bg-white pt-2 pb-2 text-center" data-aos="fade">
          <p><img src="../../../backend/web/images/bg_hero.png" alt="Image" class="img-fluid"></p>
        </div> <!-- .section -->
            ...
            <div class="row">
              ...
              <div class="col-md-6 pl-md-5 text-center mb-5">
                <div class="ftco-38">
                  <div class="ftco-38-img">
                    <div class="ftco-38-header">
                      <img src="../../../backend/web/images/mouhuan.jpg" alt="Image">
                      <h3 class="ftco-38-heading">马了顶大</h3>
                      <p class="ftco-38-subheading"><a href="../../../data/team/test2.pdf" download="test2">Teamwork</a></p>
                    </div>
                    <div class="ftco-38-body">
                      <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
                      <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. It is a paradisematic country.</p>
                  ...
                  <div class="tab-pane fade show active" id="pills-breakfast" role="tabpanel" aria-labelledby="pills-breakfast-tab">
                    <div class="d-block d-md-flex menu-food-item">
                      ...
                      <div class="text order-1 mb-3">
                        <img src="../../../backend/web/images/img_1.jpg" alt="Image">
                    ...
                    <div class="d-block d-md-flex menu-food-item">
                      <div class="text order-1 mb-3">
                        <img src="../../../backend/web/images/img_2.jpg" alt="Image">
                    ...
                    <div class="d-block d-md-flex menu-food-item">
                      <div class="text order-1 mb-3">
                        <img src="../../../backend/web/images/img_3.jpg" alt="Image">
                ...
                <div class="owl-carousel home-slider-loop-false">
                  ...
                  <div class="item">
                    <blockquote class="testimonial">
                      ...
                      <div class="author">
                        <img src="../../../backend/web/images/person_1.jpg" alt="Image placeholder" class="mb-3">
                        <h4>Maxim Smith</h4>
                        <p>CEO, Founder</p>
                      </div>
                    </blockquote>
                  ...
                  <div class="item">
                    <blockquote class="testimonial">
                      ...
                      <div class="author">
                        <img src="../../../backend/web/images/person_2.jpg" alt="Image placeholder" class="mb-3">
                        <h4>Geert Green</h4>
                        <p>CEO, Founder</p>
                      </div>
                    </blockquote>
                  ...
                  <div class="item">
                    <blockquote class="testimonial">
                      ...
                      <div class="author">
                        <img src="../../../backend/web/images/person_3.jpg" alt="Image placeholder" class="mb-3">
                        <h4>Dennis Roman</h4>
                        <p>CEO, Founder</p>
                      </div>
                    </blockquote>
    ...
    <script src="../../../backend/web/js/jquery-3.2.1.min.js"></script>
    <script src="../../../backend/web/js/jquery-migrate-3.0.1.min.js"></script>
    <script src="../../../backend/web/js/popper.min.js"></script>
    <script src="../../../backend/web/js/bootstrap.min.js"></script>
    <script src="../../../backend/web/js/owl.carousel.min.js"></script>
    <script src="../../../backend/web/js/jquery.waypoints.min.js"></script>

    <script src="../../../backend/web/js/bootstrap-datepicker.js"></script>
    <script src="../../../backend/web/js/jquery.timepicker.min.js"></script>
    <script src="../../../backend/web/js/jquery.stellar.min.js"></script>

    <script src="../../../backend/web/js/jquery.easing.1.3.js"></script>    

    <script src="../../../backend/web/js/aos.js"></script>
    

    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>

    <script src="../../../backend/web/js/main.js"></script>
  </body>
</html>